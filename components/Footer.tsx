      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="font-semibold">Asaadi senior</li>
              <li><a href="mailto:info@buyungagroup.com" className="hover:text-teal-accent transition-colors">info@buyungagroup.com</a></li>
              <li><a href="tel:+256752402404" className="hover:text-teal-accent transition-colors">+256 752 402404</a></li>
          ...
          <div>
            ...
            <div className="flex space-x-3">
                ...
                <SocialIcon href="https://www.facebook.com/BuyungaConstructionGroup" bgColor="bg-blue-600">
